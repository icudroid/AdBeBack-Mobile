...
import fr.k2i.adbeback.business.jackpot.JackPotQuestionBean;
import fr.k2i.adbeback.business.jackpot.JackPotResultBean;
...
public class PlayJackPotActivity extends ListActivity{
	...
	private void toLate() {
		...
		try {
			ServerConnexion.sendRequest("Android/TVJackPot/toLateJackpot", params);
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			JSONObject obj = ServerConnexion.sendRequest("Android/TVJackPot/getJackPotChanel", params);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,long id) {
				...
				try {
					JSONObject obj = ServerConnexion.sendRequest("Android/TVJackPot/doResponseJackpot", params);
